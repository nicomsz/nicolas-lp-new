...
export const Footer = ({ darkMode }: FooterProps) => {
  ...
  return (
    <div className='relative mx-auto max-w-[1120px] mt-12'>
      ...
      <footer
        className="max-w-4xl mx-auto px-6 py-12 md:p-12 rounded-[40px] mb-4 border text-center relative"
        style={{
          borderColor: 'var(--border)',
          backgroundColor: 'var(--bg-main)',
        }}
      >
        <h2 className="text-3xl md:text-5xl font-bold mb-8">{t('footer.title')}</h2>
        <div className="flex flex-col items-center gap-3">
          <a
            href="mailto:nicolasmdesouza@gmail.com"
            className="text-sm md:text-base opacity-70 hover:opacity-100 transition-opacity"
          >
          ...
          <div className="flex gap-5 mt-4">
            <a
              href="https://linkedin.com/in/nicolasmdesouza"
              target="_blank"
          ...
          <p className="text-xs opacity-30 mt-4 uppercase tracking-widest">
            {t('footer.location')}
          </p>
        </div>
      </footer>
