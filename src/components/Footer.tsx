      ...
      >
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <a 
            ...
            className="text-lg font-medium px-6 py-2 border rounded-full transition-all duration-300 hover:scale-105 inline-block"
            style={{ borderColor: 'var(--border)' }}
          >
            +55 47 99287-9838
          </a>
          <div className="flex gap-4 mt-2">
            <a 
              ...
              className="p-3 border rounded-full transition-all duration-300 hover:scale-110 inline-flex items-center justify-center"
              style={{ borderColor: 'var(--border)' }}
              aria-label="LinkedIn"
            >
